      ...
      >
        <div>
          <div className="space-y-6 max-w-xl mx-auto">
            ...
            >
              ჩამოტვირთე ჩვენი აპლიკაცია და მიიღე 30% იანი ფასდაკლება
            </h1>
            <p data-aos="fade-up" className="text-center sm:px-20">
              აპლიკაციაში შეგიძლიათ შეიყვანოთ თქვენი ვარჯიშის მონაცემები, ასევე პირდაპირი კონტაქტი გქონდეთ პირად ტრენერთან.
            </p>
            <div
              data-aos="fade-up"
